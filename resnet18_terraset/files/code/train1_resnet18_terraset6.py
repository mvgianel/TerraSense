...
# Train ResNet-18 on Terraset6 data stored as file of images
...
def get_arguments():
    ...
    #ap.add_argument("-n",  "--network", default="ResNet18_terraset6_train1", help="input CNN")
...
# ==========================================================================================
# Training for 50 epochs on Terraset6
# ==========================================================================================
...
plt.savefig("./doc/images/" + "train1_resnet18_terraset6_network" + "_plot.png")


# ==========================================================================================
print("\n[DB INFO] End of ResNet18 Training1 on Terraset6...\n")
